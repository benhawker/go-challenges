...
// Input: {16,16,16}
// Output: 7
// The output solution looks as follows. First apply an incremental operation to each 
// element. Then apply the doubling operation four times. Total number of operations is 3+4=7
// Input:{100}
// Output:9
// Input:{0,0,1,0,1}
// Output: 2
